                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ Route('product-stocks', $product->id) }}" class="btn btn-primary w-min-sm m-b-0-25 waves-effect waves-light">Stocks</a>
                            @else
                            <a href="{{ Route('add-product-stock', $product->id) }}" class="btn btn-primary w-min-sm m-b-0-25 waves-effect waves-light">Add stock</a>
                            @endif
