                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p>{{ __('Thank you for ordring from') }} <a href="{{ url('/') }}" style="color: #be2327; text-decoration: underline;" target="_blank">Marina Azer</a>. {{ __('We Will contact you and proceed your order as soon as possible') }}.</p>
                                    <p>
                                        @php 
