...
<div class="bredcrumbWrap bredcrumbWrapPage bredcrumb-style2 text-center">
    <div class="container breadcrumbs">
        <a href="{{ url('/') }}" title="Back to the home page">Home</a><span aria-hidden="true">|</span><span class="title-bold">My Account</span>
    </div>
</div>
        ...
        <div class="row align-items-center g-0">
            ...
            <div class="col-xl-2 col-lg-2 col-sm-6">
                <div class="d-single-info text-lg-center">
                    <a class="view-cart" href="{{ route('cart') }}"><i class="icon an an-shopping-bag me-1"></i>View Cart</a>
                </div>
            </div>
        </div>
    </div>
