            ...
            <div class="colxl-12 col-lg-12 col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('products', $product->Category->slug) }}">{{ $product->Category->title }}</a></li>
        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                ...
                <div class="sp-wrap">
                    ...
                    <a href="{{ url('/uploads') }}/{{ $item->path }}"><img src="{{ url('/uploads') }}/{{ $item->path }}" alt="{{ $product->title }}"></a>
                    @endforeach
                </div>
                @endif
            </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                <div class="prd_details">
                    ...
                    <div class="prt_01 mb-2"><span class="text-success bg-light-success rounded px-2 py-1">{{ $product->Category->title }}</span></div>
                    <div class="prt_02 mb-3">
                        ...
                        <div class="text-left">
                            <div class="star-rating align-items-center d-flex justify-content-left mb-1 p-0">
                                ...
                                @endfor
                                <span class="small">({{ $reviews->Count() }} Reviews)</span>
                            </div>
                            <div class="elis_rty">
                                @if ($product->sale_price != NULL && $product->sale_end_date > now())
                                <span class="ft-medium text-muted line-through fs-md mr-2">{{ number_format($product->price) }} AED</span>
                                <span class="ft-bold theme-cl fs-lg mr-2">{{ number_format($product->sale_price) }} AED</span>
                                @else
                                <span class="ft-bold fs-lg mr-2 text-dark">{{ number_format($product->price) }} AED</span>
                                @endif
                                @if($stock->Count() > 0)
...
<!--                    <div class="prt_04 mb-2">
                    ...
                    <div class="prt_04 mb-4">
                        @if($product->color != '')<p class="d-flex align-items-center mb-1">Color:<strong class="fs-sm text-dark ft-medium ml-1">{{ $product->Color->title }}</strong></p>@endif
                        <p class="d-flex align-items-center mb-1">Category:<a href="{{ route('products', $product->Category->slug) }}" title="{{ $product->Category->title }}"><strong class="fs-sm text-dark ft-medium ml-1">{{ $product->Category->title }}</strong></a></p>
                        @if($product->code != '')<p class="d-flex align-items-center mb-0">Code:<strong class="fs-sm text-dark ft-medium ml-1">{{ $product->code }}</strong></p>@endif
                    </div>
                    @if($available_sizes->Count() > 0)
                    <form class="addtocart col-md-12" method="post" action="{{ Route('add-to-cart') }}">
                        @csrf
                        <div class="prt_04 mb-4">
                            ...
                            <div class="text-left pb-0 pt-2">
                                ...
                                <div class="form-check size-option form-option form-check-inline mb-2">
                                    <input class="form-check-input" type="radio" name="size-option" id="swatch-1-{{ $size->Size->symbol }}" value="{{ $size->Size->id }}" data-stock='{{ $size->stock }}'>
                                    <label class="form-option-label swatchLbl" for="swatch-1-{{ $size->Size->symbol }}">{{ $size->Size->title }}</label>
                                </div>
                                @endforeach
                                <div class="form-check size-option form-option form-check-inline mb-2">
                                ...
                                <div class="d-none" id="csContainer">
                                    @if($product->category == '4') <!-- Dress & kaftan -->
...
Dress/Kaftan Length:</textarea>
                                    @elseif($product->category == '5') <!-- Travel Wear	-->
...
Abaya Length:</textarea>
                        ...
                        <div class="prt_05 mb-4">
                            <div class="form-row mb-7">
                                ...
                                <input type="hidden" name="product" value="{{ $product->id }}" class="product-form__input qty" />
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">{{ $product->Category->title }} Size Chart</h5>
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="slide_items">
                    ...
                    @php $product = $relatedProduct; @endphp
