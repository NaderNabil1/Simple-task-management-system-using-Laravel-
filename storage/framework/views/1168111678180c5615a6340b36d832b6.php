                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="card_number" class="form-control" placeholder="5426 4586 5485 4759" />
                                                    </div>
                                                </div>									
                                                ...
                                                <div class="col-lg-5 col-md-5 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select" name="expire_month">
                                                ...
                                                <div class="col-lg-5 col-md-5 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select" name="expire_year">
                                                ...
                                                <div class="col-lg-2 col-md-2 col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="cvc" class="form-control" placeholder="CVV*">
                                                    </div>
                                                </div>										
...
<?php echo $__env->make('FrontEnd.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\laplain.ae\resources\views/FrontEnd/Cart/checkout.blade.php ENDPATH**/ ?>