    ...
    <div class="d-block border rounded mfliud-bot">
        ...
        <div class="dashboard_author">
            ...
            <ul class="dahs_navbar" role="tablist">
                ...
                <li><a class="nav-link" href="<?php echo e(route('logout')); ?>"><i class="lni lni-power-switch mr-2"></i> logout</a></li>
            </ul>
        </div>
...
<?php /**PATH E:\xampp\htdocs\laplain.ae\resources\views/FrontEnd/Account/sidebar.blade.php ENDPATH**/ ?>