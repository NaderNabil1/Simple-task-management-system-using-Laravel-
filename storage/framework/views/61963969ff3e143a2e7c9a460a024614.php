    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" id="form" action="<?php echo e(route('password.update')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('FrontEnd.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\laplain.ae\resources\views/auth/passwords/reset.blade.php ENDPATH**/ ?>