                ...
                <div class="row">
                    <div class="col-md-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input name="title" type="text" class="form-control" id="title" placeholder="Enter country name">
                        </div>
                    </div>
                    <div class="col-md-6 col-xs-12">
                        <div class="form-group">
                            <label for="shipping_price">Shipping price</label>
                            <input name="shipping_price" type="number" class="form-control" id="shipping_price" placeholder="Enter shipping price">
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('BackEnd.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\laplain.ae\resources\views/BackEnd/Country/add.blade.php ENDPATH**/ ?>