                                ...
                                <a href="<?php echo e($banner->link); ?>">
                                    <div class="home-slider-desc">
                                        <div class="home-slider-title mb-4">
                                            <h5 class="theme-cl fs-sm ft-ragular mb-0">Stay Tuned</h5>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="single_cats">
                            <a href="<?php echo e(route('products', $homeCategory->slug)); ?>"
                                ...
                                <div class="bg-image"
                                    style="background:url(<?php echo e(asset('FrontEnd/img/bt-1.png')); ?>)no-repeat;"
                                    data-overlay="4"></div>
                                <div class="ct_body">
                                    <div class="ct_body_caption center text-center">
                                        <h6 class="mb-1 text-light">New Collections</h6>
                                        <h3 class="m-0 ft-bold lh-1 text-light fs-md text-upper">
                                            <?php echo e($homeCategory->title); ?></h3>
                                    </div>
                                    <div class="ct_footer center">
                                        <span class="btn btn-white stretched-link fs-md">Shop Now <i
...
<?php echo $__env->make('FrontEnd.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\laplain.ae\resources\views/FrontEnd/Page/index.blade.php ENDPATH**/ ?>