<?php $__env->startSection('title'); ?> Add subcategory <?php $__env->stopSection(); ?>
...
<div class="content-area p-y-1">
    <div class="container-fluid">
        <h4>Add <?php echo e($category->title); ?> subcategory</h4>
        <ol class="breadcrumb no-bg m-b-1">
            <li class="breadcrumb-item"><a href="<?php echo e(url('/')); ?>">Home</a></li>
            <li class="breadcrumb-item"><a href="<?php echo e(Route('be-categories')); ?>">Categories</a></li>
            <li class="breadcrumb-item"><a href="<?php echo e(Route('be-subcategories', $category->id)); ?>"><?php echo e($category->title); ?> subcategories</a></li>
    ...
    <div class="container-fluid">
        <div class="box box-block bg-white">
            <div class="row">
                <div class="col-md-6 col-xs-12"><h5 class="m-b-1">Add subcategory</h5></div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <textarea name="return_policy" rows="4" id="return_policy" class="form-control" placeholder="Enter return policy"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="file" name="banner" class="dropify" id="banner" data-max-file-size="2M">
                            </div>
                        </div>
                        <div class="col-md-6 col-xs-12">
                            <div class="form-group">
                                <label for="side_banner">Side banner</label>
                                <input type="file" name="side_banner" class="dropify" id="side_banner" data-max-file-size="2M">
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<?php echo $__env->make('BackEnd.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\laplain.ae\resources\views/BackEnd/Category/addSubCategory.blade.php ENDPATH**/ ?>