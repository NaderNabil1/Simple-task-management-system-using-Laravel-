...
<div class="content-area p-y-1">
    ...
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <a href="<?php echo e(Route('add-product')); ?>" class="btn btn-primary w-min-sm m-b-0-25 waves-effect waves-light pull-right">Add Product</a>
            ...
            <table class="table table-striped table-bordered dataTable" id="table-1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($product->Color->title); ?></td>
...
<?php echo $__env->make('BackEnd.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\laplain.ae\resources\views/BackEnd/Product/index.blade.php ENDPATH**/ ?>