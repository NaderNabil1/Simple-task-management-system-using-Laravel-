<?php $__env->startSection('title'); ?> Login & Register <?php $__env->stopSection(); ?>
    ...
    <div class="container">
        <div class="row align-items-start justify-content-between">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                <form method="post" action="<?php echo e(route('login')); ?>" id="login-form" class="border p-3 rounded">		
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="flex-1">
                                <input class="checkbox-custom" value="1" name="remember" id="remember" <?php echo e(old('remember') ? 'checked' : ''); ?> type="checkbox">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mfliud">
                <form class="border p-3 rounded" method="POST" id="create-account" action="<?php echo e(route('register')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('FrontEnd.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\laplain.ae\resources\views/auth/register.blade.php ENDPATH**/ ?>