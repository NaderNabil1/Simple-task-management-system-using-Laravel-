                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <div class="form-group">
                            ...
                            <input name="title" type="text" class="form-control" id="title" placeholder="Enter city name" value="<?php echo e($city->title); ?>">
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('BackEnd.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\laplain.ae\resources\views/BackEnd/City/edit.blade.php ENDPATH**/ ?>