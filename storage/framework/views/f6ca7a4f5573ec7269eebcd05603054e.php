                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="role" id="">
                                ...
                                <option <?php echo e($admin->role == 'Operations' ? 'selected' : ''); ?> value="Operations">Operations</option>
                                <option <?php echo e($admin->role == 'Data Entry' ? 'selected' : ''); ?> value="Data Entry">Data Entry</option>
                                <option <?php echo e($admin->role == 'Editor' ? 'selected' : ''); ?> value="Editor">Editor</option>
                                <option <?php echo e($admin->role == 'Marketing' ? 'selected' : ''); ?> value="Marketing">Marketing</option>
                            </select>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group" style="overflow: hidden;">
                            ...
                            <div class="col-md-4 m-b-1 m-md-b-0">
                                <div class="pull-xs-left m-r-1">
                                    <input type="checkbox" name="status" class="js-switch" data-size="small" data-color="#2ECC71" <?php echo e($admin->status == 'Active' ? 'checked' : ''); ?>>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('BackEnd.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\laplain.ae\resources\views/BackEnd/Admin/edit.blade.php ENDPATH**/ ?>